...
$current_menu = 'Liste des avances sur salaires';
...
?> 
 ...
 foreach ($liste_avance as $key => $value) {
   ?>
        <tr>
          <td> <?php echo $value->nom.' '.$value->prenom ?></td>
          <td><?php echo $value->montant_avance ?></td>
          <td><?php echo date("d-m-Y",strtotime($value->date_avance)) ?></td>  
          <th width="15%" class="text-center"> <a href="#" class="btn btn-danger btn-sm "  data-toggle="modal" data-target="#del<?php echo $value->idpersonnel_avance ?>" ><span class="fa fa-trash"></span> supprimer </a></th>
        </tr>

          
                      <div class="modal fade" id="del<?php echo $value->idpersonnel_avance ?>" tabindex="-1" role="dialog" aria-labelledby="Fenêtre de confirmation" aria-hidden="true">
                        <div class="modal-dialog modal-md">
                          <div class="modal-content">
                            <div class="modal-header">
                              <h4><i class="fa fa-trash"></i> Suppresion d'une avance sur salaire de: <?= $value->nom.' '.$value->prenom; ?></h4>
                            </div>
                            <form action="" method="post">
                            <div class="modal-body">
                                <input type="hidden" value="<?php echo $value->idpersonnel_avance;  ?>" name="idpersonnel_avance">                             
 ...
 var table =       $('#example1').DataTable({
     ...
     "bLengthChange": false,
           ...
           "sSearch": "Rechercher une avance",
           "sEmptyTable": "Aucune avance ajout&eacute;e",
           "sInfo": "Nombre Total de avance: _TOTAL_ ",
           "sInfoEmpty": "Aucune avance ajout&eacute;e",
           "sLengthMenu": " _MENU_ avance",
                "sZeroRecords": "Aucune avance ne correspond &agrave; cette recherche",
             "sInfoFiltered": " - (Filtrer de _MAX_ avance)"
               }
        });
