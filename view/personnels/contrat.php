<?php  
$title_for_layout = 'GESTION DES CONTRATS';
$title_for_page_menu = 'Contrats';
$current_menu = 'Tableau de Bord des contrats';
...
<?php 
 ...
 foreach ($this->Helper->contratpartitre() as $k   => $value) {
    echo $value;
 } 
 ?>
