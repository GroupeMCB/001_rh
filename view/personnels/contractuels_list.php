	...
	<div class="col-md-12">
        ...
        <div class="card-header">
          	...
          	<span class="pull-md-right">
          		<a class="btn btn-primary btn-sm" href="<?php echo BASE_URL; ?>/personnels/add/contractuels"><i class="fa fa-plus"></i> &nbsp; Ajouter</a> 
          	</span>
      	</div>

        <div class="card-body">
			<div class="table-responsive">
			 	<table class="table table-striped table-hover table-sm" id="contractuelsTable">
					...
					<?php foreach ($contractuels as $value): ?>
						<?php $i++; ?>
				 		<tr>
				 			...
				 			<td>
				 				<?php
				 					foreach ($departements as $departement) {
				 						if ($departement->iddepartement == $value->departement_id) {
				 			...
				 			<td>
				 				<?php
				 					foreach ($titres as $titre) {
				 						if ($titre->idtitre == $value->titre_id) {
				 							echo($titre->nom);
				 							break;
				 						}
				 					}
				 			...
				 			<td>
				 				<!-- Button action -->
				 				<a href="<?php echo BASE_URL; ?>/personnels/edit/contractuels/<?= $value->idpersonnel; ?>" class="btn btn-sm"> <i class="fas fa-user-edit"></i><a>
				 				<a href="#" data-toggle="modal" data-target="#viewModal<?= $value->idpersonnel; ?>" class=""><i class="fas fa-poll-h"></i><a>
				                        ...
				                        <div class="modal-body">
											...
											<div class="panel panel-default col-md-5">
											  	<div class="panel-body">
													<span class="text-muted">Nom et Prenoms</span>
													<br>
